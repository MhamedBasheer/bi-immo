 ...
 */
final class Version20210911173543 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE apartment (id INT NOT NULL, bed INT NOT NULL, room INT NOT NULL, bathroom INT NOT NULL, living_room INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE house (id INT NOT NULL, floor INT NOT NULL, room INT NOT NULL, bathroom INT NOT NULL, living_room INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE room (id INT NOT NULL, ac TINYINT(1) NOT NULL, room_bathroom TINYINT(1) DEFAULT NULL, balcony TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
